...
parser.add_argument("--A", help="Коэфф А Биквадратного уравнения", type=float)
parser.add_argument("--B", help="Коэфф B Биквадратного уравнения", type=float)
parser.add_argument("--C", help="Коэфф C Биквадратного уравнения", type=float)
